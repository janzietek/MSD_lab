		...
		for (x = 0; x < points.length; ++x) {
			for (y = 0; y < points[x].length; ++y) {
				if (points[x][y].getState() != 0) {
					...
					case 1:
						g.setColor(new Color(0x83A3FF));
						break;
					case 2:
						g.setColor(new Color(0x598CF3));
						break;
					case 3:
						g.setColor(new Color(0x3E7CDC));
						break;						
					case 4:
						g.setColor(new Color(0x1E70EE));
						break;						
					case 5:
						g.setColor(new Color(0x2E2EF3));
						break;						
					case 6:
						g.setColor(new Color(0x1C1CEC));
						break;						
					}
